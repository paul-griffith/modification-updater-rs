...
fn script_serialization() {
    let expected = ResourceManifest {
        ...
        attributes: Attributes {
            ...
            last_modification_signature: Some(
                "7ea951abc0ddc97f549f41a5670b06aa513b30e189050159f40e207cfe502b02".to_string(),
            ),
...
fn view_serialization() {
    let expected = ResourceManifest {
        ...
        attributes: Attributes {
            ...
            last_modification_signature: Some(
                "1f2e193ab0b2be15cef750b100bf5c6906b7a92fbb5e7c4f8fb7b68e83b4eb89".to_string(),
            ),
            attributes: BTreeMap::new(),
        },
    };
...
#[case::group(
    "group",
    "bd5f1e421d6fe1e3e5fabfd90bcf3cde685faaf3f7fcdbb61c0857f0f6bbf8cd"
)]
#[case::window(
    "window",
    "0aeb36c0376059d3a4f1c30d124a8341ade82303c9faf97c733f6f2cd949770f"
)]
#[case::report(
    "report",
    "1b580972bdd0e5fb515849b7a0d3a3df224a6d8fd6eed06ab1c762e78eedfa10"
)]
#[case::named_query(
    "named_query",
    "834eca8162b3942191a05f3d53412af34ea77280f61a38a47c5ff9a6340cb909"
)]
#[case::python(
    "python",
    "0cddcfe5f55db6c853459c5d71a96090e34191a04c5a8beb3b4d85a411b66ded"
)]
